...
const EditPost = () => {
    ...
    const { id } = useParams()
    const { singlePost, status } = useSelector(state => state.post)
    ...
    const [slug, setSlug] = useState(singlePost.slug);
    ...
    const getPostData = async () => {
        try {
            ...
            const { data } = res;
            console.log(data.data.seo_metadata);
            if (data) {
                setPostData({
                    title: data.data.title,
                    content: data.data.content,
                    seo_title: data.data.seo_title,
                    seo_metadata: data.data.seo_metadata,
                    type: data.data.type,
                })
                setSlug(data.data.slug)
                setThumbnail(data.data.thumbnail)
                setTeg(data.data.tegs)
                                ...
                                <div className="w-full">
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <TextInput
                                            ...
                                            defaultValue={postData.seo_metadata}>
                                        </TextInput>
                                    </div>
